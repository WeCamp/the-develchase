...
if ($collectionHandler->has('conferences')) {
	$collectionHandler->drop('conferences');
}
...
$conferenceCollection->setName('conferences');
...
echo "Conferences collection ID: {$conferenceCollectionId}\n";
echo "User ID Thijs: {$user1Id}\n";
echo "User ID Holger: {$user2Id}\n";

$query = 'for u in users filter "Redux" IN u.isInterestedIn return u';
